...
function Dashboard() {
  // Sample book data
  const books = [
    { title: "Book Title 1", imageUrl: image },
    ...
    <div className="container mx-auto py-8">
      <div className="flex flex-wrap items-center mb-8">
        <div className="w-full md:w-1/2 lg:w-3/5 mb-4 md:mb-0">
          ...
          <p className="mb-4">Explore our vast collection of books</p>
        </div>
      ...
      <div className="flex flex-wrap mb-8">
        {books.map((book, index) => (
          <div key={index} className="w-full md:w-1/2 lg:w-1/4 px-2 mb-4">
            <img className="w-full mb-3" src={book.imageUrl} alt="Featured Book" />
        ...
        {articles.map((article, index) => (
          <div key={index} className="w-full md:w-1/2 lg:w-1/3 px-2 mb-4">
            <div className="flex items-center mb-2">
              <img className="w-12 h-12 mr-2" src={article.imageUrl} alt="Article" />
              <div>
      ...
      <div className="flex items-center mb-2">
        <input type="email" className="px-4 py-2 rounded-md w-5/12 border border-gray-600 bg-white" placeholder="Enter your email" />
      </div>
      ...
      <div className="flex flex-wrap items-center mb-8">
        <div className="flex justify-center space-x-5  md:w-1/2 lg:w-1/3 px-2 mb-4">
          <p>Total Books: 500+</p>
      ...
      <h2 className="text-2xl font-bold mb-4">Location of Library</h2>
      <p>Library Address</p>
