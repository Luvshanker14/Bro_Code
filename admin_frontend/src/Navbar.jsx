    ...
    <div className="py-4">
      <a
        ...
        className={`group relative flex justify-center rounded px-2 py-1.5 ${
          isSelected
            ? "bg-blue-100 dark:bg-neutral-800 text-blue-700 transition ease-in-out delay-30 -translate-y-0.5 scale-10 duration-150 shadow-md shadow-slate-400 dark:shadow-black"
