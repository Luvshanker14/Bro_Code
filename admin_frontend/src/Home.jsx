        ...
        <div className="container px-5 py-6 mx-auto">
          ...
          <div className="flex flex-wrap -m-4 text-left">
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 px-4 py-6 rounded-lg shadow-md">
                ...
                <h2 className="title-font font-semibold text-4xl text-gray-900">2.7K</h2>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 px-4 py-6 rounded-lg shadow-md">
                ...
                <h2 className="title-font font-semibold text-4xl text-gray-900">1.3K</h2>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 px-4 py-6 rounded-lg shadow-md">
                ...
                <h2 className="title-font font-semibold text-4xl text-gray-900">74</h2>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 px-4 py-6 rounded-lg shadow-md">
                ...
                <h2 className="title-font font-semibold text-4xl text-gray-900">46</h2>
          ...
          <div className="flex w-full pt-6">
            <div className='flex flex-col space-y-4'>
              <h3 className="text-lg font-semibold text-center">Number of Books</h3>
              <BarChart
                ...
                height={250}
              />
              <h3 className="text-lg font-semibold text-center">Books Borrowed Over Time</h3>
              <LineChart
                    ...
                    <table className="min-w-full bg-white border rounded-md">
                      <thead className="bg-gray-100">
                        <tr className="text-left">
                          <th className="px-6 py-3 text-sm font-semibold text-gray-600">Book ID</th>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        <tr className="text-left">
                          <td className="px-6 py-4 whitespace-nowrap">B-10201-30</td>
                          <td className="px-6 py-4 whitespace-nowrap">Ancestor Trouble</td>
                          <td className="px-6 py-4 whitespace-nowrap">Maud Newton</td>
                          <td className="px-6 py-4 whitespace-nowrap">30</td>
                        </tr>
                        <tr className="text-left">
                          <td className="px-6 py-4 whitespace-nowrap">B-35201-31</td>
                          <td className="px-6 py-4 whitespace-nowrap">Life Is Everywhere</td>
                          <td className="px-6 py-4 whitespace-nowrap">Lucy Ives</td>
                          <td className="px-6 py-4 whitespace-nowrap">23</td>
                        </tr>
                        <tr className="text-left">
                          <td className="px-6 py-4 whitespace-nowrap">C-24510-45</td>
                          <td className="px-6 py-4 whitespace-nowrap">Life Of Pie</td>
